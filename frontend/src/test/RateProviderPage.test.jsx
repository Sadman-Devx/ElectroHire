...
function renderRate(initialPath = '/providers/1/rate') {
  return render(
...
// anonymous visitor is redirected to /login before RateProviderPage
...
describe('RateProviderPage — navbar by role (Day 10 fix)', () => {
